...
namespace Lexer
{
	...
	TokenContext::~TokenContext()
	{
		Log::Debug::writeLine(" TokenContext destroyed");
	...
	{
		Log::Debug::writeLine(" TokenSourceFile instance closing");
		if (fs_.good())
			fs_.close();
		Log::Debug::writeLine();
	}
	...
	Toker::~Toker()
	{
		Log::Debug::writeLine(" toker destroyed");
		delete pContext_;
	}
