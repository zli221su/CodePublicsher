...
// Author:      Zhi Li, Syracuse University                                //
//                                                                         //
// Origin:      Jim Fawcett, CST 4-187, Syracuse University                //
 ...
 * ver 2.4 : 01 Feb 15, Jim Fawcett
 * - added File::readAll()
 * - improved test stub testing
 * ver 2.3 : 31 Jan 15, Jim Fawcett
 ...
 * ver 2.0 : 04 Jun 12, Jim Fawcett
 * - made a few small changes to provide same interface as 
 *   Linux version.
 * ver 1.0 : 31 Jan 09, Jim Fawcett
 * - first release
 */
#include <fstream>
#include <string>
