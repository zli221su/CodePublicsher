...
#include "Comm.h"
#include "../../Logger/Logger.h" // path changed in 25 Apr 2019 by Zhi Li
#include "../../Utilities/Utilities.h" // path changed in 25 Apr 2019 by Zhi Li
#include "../../Cpp11-BlockingQueue/Cpp11-BlockingQueue.h" // path changed in 25 Apr 2019 by Zhi Li
#include "../../FileSystem/FileSystem.h" // path changed in 25 Apr 2019 by Zhi Li
#include <iostream>
#include <fstream>
#include <functional>
#include <algorithm>
...
namespace MsgPassingCommunication
{
  Context::Context()
  {
    saveFilePath = FileSystem::Path::getFullFileSpec("../../SaveFiles");  // default staging area for incoming files
    sendFilePath = FileSystem::Path::getFullFileSpec("../../SendFiles");  // default staging area for outgoing files
  }
  Context ctx;
